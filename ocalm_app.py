...
def download_model(open_calm_model_id):
    print(f"Downloading {open_calm_model_id}")
    snapshot_download(repo_id=open_calm_model_id)
...
def on_ui_tabs():
    ...
    with block as open_calm_interface:
        ...
        with gr.Row():
            ...
            send_btn.click(open_calm_inference, inputs=[open_calm_model_id, input_text_box, max_new_tokens, temperature], outputs=[output_text_box])
