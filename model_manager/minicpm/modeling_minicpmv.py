...
from transformers import (LlamaForCausalLM, LlamaPreTrainedModel, PreTrainedTokenizerFast,
...
class MiniCPMV(MiniCPMVPreTrainedModel):
    ...
    def init_vision_module(self):
        ...
        model.embed_dim = model.embeddings.embed_dim
        model.patch_size = model.embeddings.patch_size
...
def get_grid_placeholder(tokenizer, grid, query_num):
    ...
    rows = grid[1]
    slices = []
    for i in range(rows):  # noqa: B007
        lines = []
        for j in range(cols):  # noqa: B007
