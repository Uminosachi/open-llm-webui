...
from transformers.image_utils import (ChannelDimension, ImageInput,  # noqa: F401
                                      infer_channel_dimension_format, is_batched, is_torch_tensor,
        ...
        def converter(value):
            try:
                ...
                if key == "overflowing_values":
                    raise ValueError("Unable to create tensor returning overflowing values of different lengths. ") from err
                raise ValueError(
