...
from transformers.image_transforms import PaddingMode, get_image_size, pad, resize
from transformers.image_utils import (IMAGENET_STANDARD_MEAN, IMAGENET_STANDARD_STD,
                                      ChannelDimension, ImageInput, infer_channel_dimension_format,
                                      is_valid_image, is_vision_available, to_numpy_array,
